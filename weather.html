...
<body>
  ...
  <div class="card-main23">
    ...
    <input type="text" id="locationInput" placeholder="City Name"><br><br>
...
<div class="cardm">
  <div class="card">
    ...
    <div class="main"><span id="temp">23°C</span></div>
    <div class="mainsub"><span id="location"></span></div>
  ...
  <div class="card2">
    <div class="upper">
      <div class="humidity">
        <div class="humiditytext">Humidity<span id="humidity"></span></div>
      ...
      <div class="air">
        <div class="airtext">Wind <span id="wind"></span></div>
    ...
    <div class="lower">
      <div class="aqi">
        ...
        <div class="aqitext">AQI <span id="aqi"></span></div>
      </div>
      ...
      <div class="realfeel">
        ...
        <div class="realfeeltext">Real Feel <span id="feelsLike"></span></div>
      </div>
      ...
      <div class="pressure">
        ...
        <div class="pressuretext">Pressure <span id="pressure"></span></div>
      </div>
      <div class="card3">
      Healthy
      </div>
...
.card-main23 button:hover {
    background-color: #0056b3;
}
</style>

  <script>
    const apiKey = '735364377dea461e983161109240911';
    ...
    function fetchWeather(location) {
      ...
      fetch(url)
        ...
        .then(data => {
          if (data.error) {
            alert("City not found. Please check the location.");
          } else {
            ...
            const aqi = data.current.air_quality.pm10;  // Using PM10 as an example

            updateUI(temp, humidity, feelsLike, windSpeed, pressure, aqi, cityName, country);
          }
        })
        .catch(error => {
    ...
    function updateUI(temp, humidity, feelsLike, windSpeed, pressure, aqi, cityName, country) {
